    ...
    [
      {
        ...
        output: "./public/dist/plugin/highlight/highlight",
      },
      {
        name: "RevealMarkdown",
        input: "./plugin/markdown/plugin.js",
        output: "./public/dist/plugin/markdown/markdown",
      },
      {
        name: "RevealSearch",
        input: "./plugin/search/plugin.js",
        output: "./public/dist/plugin/search/search",
      },
      {
        name: "RevealNotes",
        input: "./plugin/notes/plugin.js",
        output: "./public/dist/plugin/notes/notes",
      },
      {
        name: "RevealZoom",
        input: "./plugin/zoom/plugin.js",
        output: "./public/dist/plugin/zoom/zoom",
      },
      {
        name: "RevealMath",
        input: "./plugin/math/plugin.js",
        output: "./public/dist/plugin/math/math",
      },
    ].map((plugin) => {
      return rollup({
...
gulp.task("css-plugins", () =>
  gulp
    .src(["plugin/highlight/monokai.css"])
    .pipe(gulp.dest("./public/dist/plugin/highlight"))
);

gulp.task("css", gulp.parallel("css-themes", "css-core", "css-plugins"));
...
gulp.task("serve", () => {
  ...
  gulp.watch(
    ["css/*.scss", "css/print/*.{sass,scss,css}", "plugin/**/*.css"],
    gulp.series("css-core", "reload")
  );

  gulp.watch(
    ["plugin/**/*.css"],
    gulp.series("css-plugins", "reload")
  );
